...
(function() {
      ...
      for (k in ref1) {
        ...
        if ((ref2 = config.plugins) != null ? ref2[v] : void 0) {
          ...
          overrideProps.plugins[v] = (overrideProps.plugins[v] || []).concat((config.plugins[v] || []).filter(function(plugin) {
            return indexOf.call(overrideProps.plugins[k] || [], plugin) < 0;
          }));
        }
      }
  ...
  deepExtend = function(object, properties, rootFiles) {
    ...
    Object.keys(properties).forEach(function(key) {
      ...
      if (toString.call(value) === '[object Object]' && indexOf.call(nestedObjs, object) < 0) {
        if (object[key] == null) {
          object[key] = {};
        }
  ...
  exports.setConfigDefaults = setConfigDefaults = function(config, configPath) {
    var base, base1, conventions, join, joinRoot, modules, overrides, paths, production, ref, server;
    join = (function(_this) {
    ...
    if (conventions.ignored == null) {
      conventions.ignored = (ref = paths.ignored) != null ? ref : [/[\\\/]_/, /vendor[\\\/](node|j?ruby-.*|bundle)[\\\/]/];
    }
