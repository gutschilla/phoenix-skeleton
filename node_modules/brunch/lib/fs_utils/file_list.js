...
(function() {
  'use strict';
  var Asset, EventEmitter, FileList, SourceFile, debug, fcache, helpers, startsWith, sysPath,
    ...
    FileList.prototype.compileDependencyParents = function(path) {
      ...
      parents = this.files.filter((function(_this) {
        return function(dependent) {
          return dependent.dependencies.length > 0 && indexOf.call(dependent.dependencies, path) >= 0 && !_this.compiled[dependent.path];
        };
      })(this));
      if (parents.length) {
