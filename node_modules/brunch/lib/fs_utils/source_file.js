...
(function() {
  'use strict';
  var SourceFile, SourceMapConsumer, SourceMapGenerator, SourceNode, debug, identityNode, isWindows, makeCompiler, makeWrapper, os, pipeline, ref, ref1, replaceBackSlashes, sysPath, updateCache, updateMap;
  ...
  ref = require('../helpers'), identityNode = ref.identityNode, replaceBackSlashes = ref.replaceBackSlashes, isWindows = ref.isWindows;

  ref1 = require('source-map'), SourceMapConsumer = ref1.SourceMapConsumer, SourceMapGenerator = ref1.SourceMapGenerator, SourceNode = ref1.SourceNode;
  ...
  module.exports = SourceFile = (function() {
    function SourceFile(path1, compilers, linters, wrapper, isHelper, isVendor) {
      var compiler, isWrapped, isntModule, ref2, wrap;
      this.path = path1;
      this.isHelper = isHelper;
      compiler = compilers[0];
      isntModule = this.isHelper || isVendor;
      isWrapped = (ref2 = compiler.type) === 'javascript' || ref2 === 'template';
