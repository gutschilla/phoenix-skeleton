...
(function() {
  'use strict';
  var SourceMapConsumer, SourceMapGenerator, SourceNode, anysort, common, concat, debug, extractOrder, flatten, fs, generate, mapOptimizerChain, optimize, ref, sort, sortByConfig, sysPath, waterfall,
  ...
  generate = function(path, sourceFiles, config, optimizers, callback) {
    var code, joinToValue, map, mapPath, ref1, sorted, type, withMaps;
