...
require.register("priv/static/bower_components/jquery/dist/jquery", function(exports, require, module) {
...
require.register("priv/static/bower_components/bootstrap/dist/js/bootstrap", function(exports, require, module) {
/*!
...
+(function ($) {
  ...
  var Button = (function (_Button) {
    var _ButtonWrapper = function Button(_x, _x2) {
...
+(function ($) {
  ...
  var Collapse = (function (_Collapse) {
    var _CollapseWrapper = function Collapse(_x, _x2) {
      return _Collapse.apply(this, arguments);
    };

    _CollapseWrapper.toString = function () {
      return _Collapse.toString();
    };

    return _CollapseWrapper;
  })(function (element, options) {
    this.$element = $(element);
...
+(function ($) {
  ...
  var Affix = (function (_Affix) {
    var _AffixWrapper = function Affix(_x, _x2) {
      return _Affix.apply(this, arguments);
    };

    _AffixWrapper.toString = function () {
      return _Affix.toString();
    };

    return _AffixWrapper;
  })(function (element, options) {
